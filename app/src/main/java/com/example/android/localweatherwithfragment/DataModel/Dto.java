...
public abstract class Dto implements Parcelable {
    ...
    public static Dto create(String resolvedAddress, List<DaysBaseModel> weatherForecastList, CurrentModel current_weather) {
        return new AutoValue_Dto(resolvedAddress, weatherForecastList, current_weather);
    }
}
